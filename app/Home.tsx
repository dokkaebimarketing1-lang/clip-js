        ...
        <div className="relative">
          <div className="mb-6 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <h2 id="studio-preview-title" className="mt-3 break-keep text-2xl font-black tracking-tight text-white sm:text-3xl">실제 제작 화면을 먼저 확인해 보세요</h2>
            </div>
